...
if __name__ == '__main__':
    ...
    transform = transforms.Compose(
        [transforms.ToTensor()])
    mnist = torchvision.datasets.MNIST('C:/Users/Mohit K/Desktop/datasets/MNIST/', download=True, transform=transform)
    ...
    vae_state_dict = torch.load('vae_final.pth', map_location='cpu')
    vae_model.load_state_dict(vae_state_dict);

    criterion = nn.MSELoss()

    enc = vae_model.encoder(im0.reshape(-1, 784))
    z = vae_model._sample_latent(enc)
    recons_im0 = vae_model.decoder(z)
